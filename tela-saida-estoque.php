...
<head>
    ...
    <link rel="stylesheet" href="css/saida-estoque.css">
...
<body>
    ...
    <div class="principal">
        <div class="opcoes">
            <form action="registro-saida-estoque.php" method="POST" class="form-cadastro">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="data-saida" name="data_saida" required>
                </div>
